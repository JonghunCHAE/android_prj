    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* setItems는 단순 선택지이기때문에 선택해야할것처럼 안 보입니다.
                ...
                */
                 ...
                 */
                // 체크박스 형식은 선택됨/안됨 여부를 true/false로 처리합니다.
                ...
                dlg.setMultiChoiceItems(animalArray, checkArray, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        ...
                        if (isChecked) {
                            Toast.makeText(MainActivity.this,
                                    animalArray[which] + "체크됨",
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(MainActivity.this,
                                    animalArray[which] + "체크해제됨",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 확인버튼 눌렀을 때 이벤트까지 거는 경우 두 번째 파라미터에 new D까지 적고
